          ...
          <form className="store">
            <div className="store">
              <div className="store-form">
                ...
                <input type="text" defaultValue="" {...register("over_price_money")} />
                <label>حداکثرقیمت%:</label>
                <input type="text" defaultValue="" {...register("over_price_percent")} />
                <label>تخفیف:</label>
                <input type="text" defaultValue="" {...register("discount_money")} />
                <label>تخفیف%:</label>
                <input type="text" defaultValue="" {...register("discount_percent")} />
              </div>
