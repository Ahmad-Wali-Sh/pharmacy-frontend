...
import PrescriptionPrint from "../Prescription/PrescriptionPrint";

function PrescriptionReturnReportBox({ report, prescription, BackFunc, FrontFunc }) {
  ...
  const OrderSubmit = () => {
    ...
    axios.patch(`${serverIP}api/prescription-return/${prescription.id}/`, Form).then(() => {
...
export default PrescriptionReturnReportBox;
