...
export default function DepartmentReturnList() {
  ...
  const { mutateAsync: newDepartment } = useMutation({
    mutationFn: (data) => postDataFn(data, "department-return/"),
    onSuccess: () =>
  ...
  const { mutateAsync: handleEditDepartment } = useMutation({
    mutationFn: (data) => putDataFn(data, `department-return/${editItem.id}/`),
    onSuccess: () =>
      successFn([departmentQuery], () => {
        setActive("list");
      }),
  ...
  const { mutateAsync: deleteDepartment } = useMutation({
    mutationFn: (id) => deleteDataFn(`department-return/${id}/`),
    onSuccess: () =>
      successFn([departmentQuery], () => {
        setActive("list");
      }),
  ...
  let departmentQuery = `department-return/?name=${filter.name}`;
