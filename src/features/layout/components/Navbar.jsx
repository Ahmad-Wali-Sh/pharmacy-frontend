      ...
      <div className="navbar-elements">
        <div className="colorfull-image">
          <img
            ...
            src="./images/frontend/no-color-sharif.png"
          />
        </div>
        ...
        <div className="navbar-buttons">
          <CanAccess permission={"core.view_prescription"}>
            <NavLink
              to="/sell"
              className={({ isActive }) =>
                isActive ? "active-navbar" : "button"
              }
            >
              <div className="button">فروشات</div>
            </NavLink>
          </CanAccess>
          {userPermissions?.includes("core.view_prescription") && (
            <NavLink
              to="/return"
              className={({ isActive }) =>
                isActive ? "active-navbar" : "button"
          ...
          {userPermissions?.includes("core.view_entrance") && (
            <NavLink
              to="/purchase"
              className={({ isActive }) =>
                isActive ? "active-navbar" : "button"
          ...
          {userPermissions?.includes("core.view_medician") && (
            <NavLink
              to="/medician"
              className={({ isActive }) =>
                isActive ? "active-navbar" : "button"
          ...
          {userPermissions?.includes("core.view_revenue") && (
            <NavLink
              to="/revenue"
              className={({ isActive }) =>
                isActive ? "active-navbar" : "button"
